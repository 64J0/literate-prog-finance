...
When using Python, it's a bit tricky to make it to show the result of the print
...
The idea to create this repository I got after start reading the book "O homem
mais rico da Babilônia" from George S. Clason. It made me start thinking more
about finances, and due to it I decided to calculate how much money I would have
in some hypothetical scenarios, considering some tips from the author.

While writing this document I noticed how little I know about org-mode and
babel. Due to it, I started looking deeper into the documentation, trying to
...
into this feature in order to really understand how it works.
